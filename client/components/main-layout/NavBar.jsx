      ...
      <div className="nav-bar">
        ...
        <div className="pure-menu pure-menu-horizontal pure-menu-fixed">
          <ul className="pure-menu-list">
            ...
            <li className="pure-menu-item"><Link to="/teams" className="pure-menu-link">Teams</Link></li>
            <li className="pure-menu-item"><Link to="/video" className="pure-menu-link">Video</Link></li>
